...
Not much is known about this level. It is in all of the official maps, though.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170412952-cd330714-a001-4197-83d7-8584e89d0a87.png' atr='full' alt='Beanstalk factory' %}

### Wonderland

This level was barely started and only had blockouts done for it.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170413146-33bf5319-19e4-4d34-b53e-f3c75e17870c.png' atr='full' alt='Wonderland' %}
...
A level with the terrain from a demo level. It features numerous effects.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170413565-ab28c6c8-a128-4143-bf0b-6c41c976d738.png' atr='full' alt='AVA Particles' %}

### Robs Particle Zoo

AVA Particles with more effects.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170413644-95c734f8-47e6-4b54-ad64-7431e81bd176.png' atr='full' alt='Robs Particle Zoo' %}

### Jeff Tses Particle Zoo

AVA Particles with two duplicate demo islands side by side. It also features exclusively thinner effects.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170413702-f1573bbf-6806-4184-ad43-402533ab060d.png' atr='full' alt='Jeff Tses Particle Zoo' %}
...
A level with various pirate props. The floor is missing.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170414027-bb193c01-f6d7-480f-a99b-b66aaaeefc9b.png' atr='full' alt='Jamey Test' %}

### Jimmie AVA Test

A blank template of AVA Particles.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170414155-827862d2-838d-46e4-a825-62005030f04b.png' atr='full' alt='Jimmie AVA Test' %}

### Common FX Zoo

A grey baseplate with various liquid effects on top of it.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170414313-8c4c5851-7f64-4155-bb5a-8e2d79084a87.png' atr='full' alt='Common FX Zoo' %}

### EB VillageTest

An area without lighting that contains a flat plane of grass with a single hut placed on it.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170413328-0fa5751e-bb62-41b1-bc77-47731e01c7ad.png' atr='full' alt='EB VillageTest' %}
...
If you go to an  out of bounds location in Tortooga, Gus will simply say "Dead men tell no tales". As creepy as this may seem, it's supposedly a cut password system and reference to Pirates of the Carribean.

{% include image.html src='https://user-images.githubusercontent.com/83473579/170412386-1da028d2-a7ea-4198-a671-ab4b6bfc7028.png' atr='full' alt='Dead men tell no tales.' %}
...
Some HUD files have icons or graphics that are outside of the normal display area of the game, meaning they are hidden to most players. Most of these are to test resolutions and image loading.
...
{% include image.html src='https://user-images.githubusercontent.com/83473579/170406094-f76156c9-b7b8-4b25-b9bf-4b75a03b191f.png' atr='full' alt='Vending machine' %}
# Sketches
...
{% include image.html src='https://media.discordapp.net/attachments/812861974446473276/915467556138147911/frames.gif' atr='full' alt='Balloon HUD icon' %}
...
{% include image.html src='https://media.discordapp.net/attachments/812861974446473276/915467556356239400/frames.gif' atr='full' alt='Firework HUD icon' %}
